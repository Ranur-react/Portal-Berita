            ...
            <div class="row"> 
                ...
                <div class="row">
                    ...
                    <div class="app_content">
                        <div class="row">
                            <div class="col-sm-12">
                                    <h3 class="title text-center">Penginstallan Directory dan Spesifikasi yang dibutuhkan - made by robialakbar.com</h3>
                                    <!-- display requirements -->
                                    <?= $Requirements->directoriesAndPermission(); ?>
                                    <?= $Requirements->server();      ?>

                                <div class="divider"></div>
                                <a href="index.php?step2" class="cbtn pull-right">Selanjutnya</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="app_content">
                        <div class="row">
                            <div class="col-sm-12">
                                <h3 class="title text-center margin">Informasi Penginstallan Aplikasi  - by robialakbar</h3>
                                ...
                                <form action="#" method="post" >
                                    ...
                                    <div class="form-group">
                                        <label for="database">Database Name - "Diisi dengan nama Database ( Buat dulu Database Kosong dengan nama database " news " )</label>
                                    ...
                                    <div class="form-group">
                                        <label for="username">Username  - Diisi dengan nama username database ( kalau localhost biasanya " root " )</label>
                                    ...
                                    <div class="form-group">
                                        <label for="password">Password - Diisi dengan password Database ( Kalau di localhost biasanya kosong aja passwordnya )</label>
                                    ...
                                    <div class="form-group">
                                        <label for="hostname">Host Name - Diisi saja dengan ( " localhost " )</label>
